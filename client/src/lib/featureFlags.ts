 ...
 * Flags are controlled via environment variables prefixed with VITE_ENABLE_
 */
...
export const featureFlags: FeatureFlags = {
   ...
   * 
   * To enable: Set VITE_ENABLE_COLLABORATIVE_CONTRACTS=true in environment
   */
  collaborativeContracts: isFeatureEnabled('VITE_ENABLE_COLLABORATIVE_CONTRACTS'),
};
