...
- **Async Collaborative Contracts**: Enables co-creation of consent documentation through invitation-based sharing and mutual approval workflows with robust storage and validation.
...
- **Navigation**: A bottom navigation bar with "Create", "Tools", "Contracts", and "Profile" tabs.
